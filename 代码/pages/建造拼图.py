...
import base64
from utils import get_puzzle_assets_path, back_to_home_btn
...
LEVEL_CONFIG = [
    ...
    {
        "level_id": 3,
        "level_name": "第三关：楼台成型·二十三洲",
        "history_desc": "元代韩江桥增建石墩、首用石板架桥开创先例，明宣德十年王源主持大修，加固石墩、木石筑梁、增建亭屋楼台，江心仍以铁索固定浮桥。",
