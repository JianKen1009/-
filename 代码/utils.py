...
def get_bridge_arch_image_path(arch_name: str) -> str:
    """
    获取桥亭楼阁放大图的完整路径
    :param arch_name: 桥亭全名，如“西一墩·广济奇观阁”
    :return: 图片完整绝对路径
    """
    filename = f"{arch_name}.jpg"
    return get_img_path(os.path.join("二十四楼台", filename))
